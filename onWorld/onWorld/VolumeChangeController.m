...
static NSString *const kVolumeChangeNotification = @"AVSystemController_SystemVolumeDidChangeNotification";
static NSString *const kVolumeChangeNotificationParameter = @"AVSystemController_AudioVolumeNotificationParameter";
