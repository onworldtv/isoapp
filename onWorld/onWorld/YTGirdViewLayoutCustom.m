...
static NSString * const YTLayoutItemCell = @"itemCell";

@interface YTGirdViewLayoutCustom()
@property (nonatomic, strong) NSDictionary *layoutInfo;
@end

@implementation YTGirdViewLayoutCustom
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[YTLayoutItemCell] = cellLayoutInfo;
